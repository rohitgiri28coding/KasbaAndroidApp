...
//    Category("Categories", r.category_icon),
//    Category("Sarees", R.drawable.sarees),
//    Category("Kurtas & Kurtis", R.drawable.kurtas_kurtis),
//    Category("Jewelry", R.drawable.jewelry),
//    Category("Handicrafts", R.drawable.handicrafts),
//    Category("Footwear", R.drawable.footwear),
//    Category("Home Decor", R.drawable.home_decor),
//    Category("Traditional Bags", R.drawable.traditional_bags),
//    Category("Puja Essentials", R.drawable.puja_essentials),
//    Category("Shawls", R.drawable.shawls),
//    Category("Ethnic Jackets", R.drawable.ethnic_jackets)
//)
//val prodList = listOf(
//    ProductDetails(
...
//    weight = 500,
//    rating = 4.6f,
//    imageSet = listOf(r.madhubani_painting1, r.madhubani_painting2),
//    id = 11
//    ),
//    ProductDetails(
...
//    weight = 400,
//    rating = 4.5f,
//    imageSet = listOf(r.chikankari_kurta1, r.chikankari_kurta2, r.chikankari_kurta3),
//    id = 12
//    ),
//    ProductDetails(
...
//    weight = 300,
//    rating = 4.9f,
//    imageSet = listOf(r.pashmina_shawl1, r.pashmina_shawl2),
//    id = 13
//    ),
//    ProductDetails(
...
//    weight = 100,
//    rating = 4.7f,
//    imageSet = listOf(r.terracotta_necklace1, r.terracotta_necklace2),
//    id = 14
//    ),
//    ProductDetails(
...
//    weight = 250,
//    rating = 4.8f,
//    imageSet = listOf(r.brass_diya1, r.brass_diya2),
//    id = 15
//    ),
//    ProductDetails(
//    name = "Jute Handbag",
...
//    weight = 350,
//    rating = 4.4f,
//    imageSet = listOf(r.jute_bag1, r.jute_bag2),
//    id = 16
//    ),
//    ProductDetails(
...
//    weight = 1200,
//    rating = 4.5f,
//    imageSet = listOf(r.block_print_bedsheet1, r.block_print_bedsheet2),
//    id = 17
//    ),
//    ProductDetails(
...
//    weight = 600,
//    rating = 4.9f,
//    imageSet = listOf(r.banarasi_saree1, r.banarasi_saree2),
//    id = 18
//    ),
//    ProductDetails(
//    name = "Clay Water Pot",
...
//    weight = 2500,
//    rating = 4.6f,
//    imageSet = listOf(r.clay_pot1, r.clay_pot2),
//    id = 19
//    ),
//    ProductDetails(
...
//    weight = 1500,
//    rating = 4.7f,
//    imageSet = listOf(r.wooden_lamp1, r.wooden_lamp2),
//    id = 20
//    )
//)
